...
class SubClimber : public frc2::SubsystemBase {
 ...
 private:
  ...
  frc::sim::ElevatorSim lElvSim{frc::DCMotor::NEO(), gearRatio, 56_kg, (WheelCir/std::numbers::pi)/2, BaseHeight, 5_m, false, BaseHeight};
  frc::sim::ElevatorSim rElvSim{frc::DCMotor::NEO(), gearRatio, 56_kg, (WheelCir/std::numbers::pi)/2, BaseHeight, 5_m, false, BaseHeight};
